...
export default function StorageCleaner() {
  useEffect(() => {
    ...
    try {
      ...
      // PRESERVE student code before clearing
      const studentCodeKey = 'student_code';
      const preservedCode = localStorage.getItem(studentCodeKey);
      
      // Clear localStorage completely
      localStorage.clear();
      
      // RESTORE student code after clearing
      if (preservedCode) {
        localStorage.setItem(studentCodeKey, preservedCode);
        console.log('🔒 PRESERVED: Student code kept in storage');
      }
