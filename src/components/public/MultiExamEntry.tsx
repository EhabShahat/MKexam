            ...
            <div>
              ...
              {storedCode && (
                <div className="text-center mb-6 pb-6 border-b border-gray-200">
                  <div className="inline-flex flex-col items-center gap-1 px-4 py-2 bg-green-50 border border-green-200 rounded-lg">
                    <div className="flex items-center gap-2">
                      <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      {studentName && <span className="text-lg font-bold text-gray-900 tracking-wider">{studentName}</span>}
                    </div>
                    <span className="text-sm text-gray-600 font-mono">{storedCode}</span>
                  </div>
                </div>
              )}
