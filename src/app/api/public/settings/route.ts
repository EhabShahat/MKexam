...
import { cachedJsonResponse, handleConditionalRequest } from "@/lib/cacheHeaders";
...
export async function GET(request: Request) {
  try {
    ...
    // Return with cache headers (30 minutes TTL for app config)
    return handleConditionalRequest(request, result, 'LONG');
  } catch (e: any) {
