...
import { registerConsoleCommands } from "@/lib/deviceInfoDiagnostics";
...
export default function AdminLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <AdminGuard>
      ...
      <div className="min-h-screen min-h-[100svh]" style={{ background: 'var(--background)' }}>
        {!isIdCardPage && (
        <header className="border-b shadow-sm sticky top-0 z-10 safe-area-top card">
          ...
          {mobileMenuOpen && (
            <div className="lg:hidden border-t shadow-md card">
