                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-xs text-gray-500 bg-gray-100 px-1.5 py-0.5 rounded">{parsed.browser?.version || browser.version || "?"}</span>
                                                </div>
                                                <div className="text-xs text-gray-600 flex items-center gap-1">
                                                    ...
                                                    OS: {parsed.os?.name || os.name || "Unknown"}
                                                </div>
                                            </div>
                                                    ...
                                                    {logsQ.data.filter((x: any) => x.id !== attemptId).map((ext: any) => (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex flex-col items-end">
                                                                <StatusBadge status={ext.completion_status} size="xs" />
