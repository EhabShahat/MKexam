-- Migration: Fix calculate_result_for_attempt to handle boolean, string, and array correct_answers
-- This fixes the "cannot extract elements from a scalar" error for all question types
...
'Calculates exam results with support for boolean, string, and array correct_answers formats. Handles all question types including true_false (boolean), single_choice (string), multiple_choice (array), and manual grading.';
